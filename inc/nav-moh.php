<?php
/**
 * This partial contains site navigation for the music oral history resource.
 *
 * @link https://github.com/MITLibraries/music-oral-history
 *
 * @package WordPress
 * @subpackage music-oral-history theme
 * @since 1.1.11
 */
...
<nav id="nav-main" class="nav-main flex-container nav-moh">
  <div class="link-primary flex-container flex-end">
    <a href="/music-oral-history" class="no-underline">Music Oral History home</a>     
  </div><!-- end div.links-primary -->
    <div class="link-primary flex-container flex-end">
    <a href="/music-oral-history/interviewees" class="no-underline">Index of interviewees</a>
  </div><!-- end div.links-primary -->
  <div class="link-primary flex-container flex-end">
    <a href="/music-oral-history/search-all-interviews" class="no-underline">Search all interviews</a>
  </div><!-- end div.links-primary -->
  <div class="link-primary flex-container flex-end">
    <a href="/music-oral-history/about-the-project" class="no-underline">About the project</a>
  </div>
  <div class="link-primary flex-container flex-end">
    <a href="/music-oral-history/terms-of-use" class="no-underline">Terms of use</a>
  </div><!-- end div.links-primary -->
</nav>
